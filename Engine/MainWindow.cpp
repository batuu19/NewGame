	...
	hInst(hInst)
{
	...
	hWnd = CreateWindow(wndClassName,L"Game",
...
LRESULT __stdcall MainWindow::_HandleMsgSetup(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
LRESULT __stdcall MainWindow::_HandleMsgThunk(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
